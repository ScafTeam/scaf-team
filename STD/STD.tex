...
\section*{4. 測試工作指派與時程(Personnel and Schedule)}
\subsection*{4.1測試成員(Personnel)}
\begin{tabularx}{\textwidth}{
...
\section*{5. 測試結果與分析(Test Results and Analysis)}
\subsection*{5.1 測試結果(Test Results)}
\begin{tabularx}{\textwidth}{
  |p{\dimexpr.25\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.25\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.5\linewidth-2\tabcolsep-1.33333\arrayrulewidth}|%
...
\subsection*{5.2 缺失報告(Defect Tracking)}
\begin{tabularx}{\textwidth}{
  |p{\dimexpr.14\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.14\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.14\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.14\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.14\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.14\linewidth-2\tabcolsep-1.33333\arrayrulewidth}%
  |p{\dimexpr.16\linewidth-2\tabcolsep-1.33333\arrayrulewidth}|%
  }
  \hline
  \centering 缺失標號 &  
  \makecell[c]{
