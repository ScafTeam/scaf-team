...
\begin{tabularx}{\textwidth}{
  ...
  SCAF-FR-07 & repository & 使用者在同一個專案中可以共同使用reository(Github)。 \\ \hline
  SCAF-FR-08 & 需求文件 & 使用者可以填入與客戶商討後的需求。 \\ \hline
  SCAF-FR-09 & 設計文件 & 使用者可以填入 API 形式和資料庫規範。 \\ \hline
  SCAF-FR-10 & 命名規範 & 使用者可以在命名錯誤時修正。 \\ \hline
  SCAF-FR-11 & 風格規範 & 方便閱讀他人 code。 \\ \hline
  SCAF-FR-11 & commit規範 & 統一commit格式。 \\ \hline
  SCAF-FR-12 & 版本控管 & 使用者可以利用 git 各項功能。 \\ \hline
  SCAF-FR-13 & 工作計畫排程 & 使用者可以利用看板、行事曆,來觀察專案的排程。 \\ \hline
  SCAF-FR-14 & 通知 & 使用者接收專案內的更動通知、其他專案的邀請。 \\ \hline
  SCAF-FR-15 & 設定 & 使用者可以更改自己的名稱、信箱、自介、密碼。 \\ \hline
  SCAF-FR-16 & 問答 & 使用者可以在Q\&A文件中查詢自己的問題，並尋找答案。 \\ \hline
  SCAF-FR-17 & 專案管理 & 使用者(專案擁有者)可以對專案進行名稱、人員變更。 \\ \hline
\end{tabularx}
